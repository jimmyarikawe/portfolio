...
export const projects: Project[] = [
  ...
  },
  {
    ...
    "overview": "Say thank you in Yorùbá and you have to settle something English never asks you to settle: who you are speaking to. Ẹ ṣé is for an elder, or anyone you are being formal with. O ṣé is for a friend. Get it wrong and the sentence is still grammatical, still means thank you, and still lands badly.",
    "challenge": "Six groups have to live in it and they want opposite things. Creators abandon anything that looks like a wizard. Developers read the interface as documentation. Businesses want an audit trail more than they want range. Researchers value a stated gap over a confident answer. Contributors are usually on a phone and offline half the time. Everyday users never see the platform at all, only what comes out of it.",
    "solution": "Pison only works as a loop. People contribute recordings, translations and cultural knowledge; those become reviewed, versioned datasets; models train on them; the models ship as eight product surfaces and an API; and what those earn pays the contributors who started it. Design any one layer on its own and you get either a demo with nothing behind it or a data platform nobody has a reason to use.",
    "designSystem": "One token set drives both front-ends: a warm neutral ground rather than clinical white, a 1.5rem card radius, pill controls, seven named type ramps. Dark mode is re-derived from the same warm neutrals rather than inverted, and checked for contrast rather than assumed. The system carries the parts a voice product needs and a generic one does not, including waveform players, recorders with live quality checks, dialect selectors, provenance badges and timeline views, plus a full set of states for loading, empty, error, offline, permission denied and processing. An AI product spends most of its life in one of those rather than on the happy path.",
    "figures": [],
    "gallery": [
    ...
    "takeaways": "What surprised me was how much of the design work happened in the data model. I expected the hard problems to be in the studio. They were in deciding that a language has a tonality and a coverage gap, that a voice has an origin, and that a contribution has a lineage. Before those existed, no amount of interface craft would have produced a product that was right, only one that looked right, which in an AI product is the more dangerous of the two."
  },
  {
    "id": "03",
    "featured": true,
